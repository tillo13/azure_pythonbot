...
APP_VERSION = "1.0707.1006"  
  
def generate_footer(platform: str, response_time: float, model_name: str = "gpt4o", input_tokens: int = 0, output_tokens: int = 0) -> str:  
    ...
    Args:  
        ...
        model_name (str, optional): The name of the OpenAI model used. Defaults to "gpt4o".  
